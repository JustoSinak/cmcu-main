...
<div id="examens_scannes_form" style="display: none;">
    ...
    <div class="row ">
        ...
        <div class="col-md-6 mt-3">
            <div class="container_">
                <div class="button_container_add border rounded-lg ">
                    <div class="d-flex align-items-center add_button justify-content-center" data-bs-toggle="popover" title="Description" data-content="{{ $examen->description }}" style="cursor: pointer;">
       ...
       <button class="btn btn-info " data-bs-toggle="modal" data-target="#modal_examens_scannes" title="Ajouter une image"><i class="fas fa-plus"></i></button>
