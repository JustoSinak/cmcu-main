            ...
            <div class="container">
                <div class="row">
                    @can('infirmier', \App\Models\Patient::class)
                        <button type="button" class="btn btn-primary mb-2 me-2" title="Surveillance pré-opératoire" data-bs-toggle="modal" data-target="#SurveillancePre" data-whatever="@mdo">
