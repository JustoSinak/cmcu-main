        ...
        <tr>
            ...
            <td>
                @if(count($patient->consultation_anesthesistes))
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-target="#VisiteAnesthesiste" title="Visite pré-anesthésique du patient" data-whatever="@mdo">
