...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user2001 = \App\Models\User::create([
            'role_id' => '2',
            'name' => 'SANDJON',
            'prenom' => 'Jean Paul',
            'login' => 'SANDJON',
        ...
        $user2101 = \App\Models\User::create([
            'role_id' => '2',
            'name' => 'EYOMGETA',
            'prenom' => 'Divine',
            'login' => 'EYOMGETA',
        ...
        $user21041 = \App\Models\User::create([
            'role_id' => '2',
            'name' => 'TOUKAM',
            'prenom' => 'Eve',
            'login' => 'TOUKAM',
        ...
        $user29041 = \App\Models\User::create([
            'role_id' => '2',
            'name' => 'CHENDJOU',
            'prenom' => 'Brice',
            'login' => 'CHENDJOU',
        ...
        $user221 = \App\Models\User::create([
            'role_id' => '9',
            'name' => 'NDOUMBE',
            'prenom' => 'CHRISTIAN',
            'login' => 'NDOUMBE',
...
//        $user1->roles()->attach(\App\Models\Role::where('name', 'ADMINISTRATEUR')->first());
    }
}